...
* [⚡ MAIN TIP: FIXING STUTTERS](#2-main-tip-fixing-stutters)
* [📦 STEP 1: PREPARATION](#3-step-1-preparation-software-pack)
* [🚀 STEP 2: INSTALLATION](#4-step-2-installation-step-by-step)
* [⚙️ STEP 3: GRAPHICS SETTINGS](#5-step-3-graphics-settings-windows-1011)
* [🆘 TROUBLESHOOTING (5 FULL METHODS)](#6-troubleshooting-5-full-methods)
* [🛠 STEP 5: MAINTENANCE](#7-step-5-maintenance--software-first-aid)
* [📚 FACT SHEET](#8-fact-sheet-technical-intel)
...
4. **Note:** If you get a black screen after this, lower the value slightly until you find the stable limit.
...
5. **Important:** Choose **"Graphics Driver Only."** Do **NOT** install NVIDIA APP or GeForce Experience, or the patch might break!

---

## 🆘 5. TROUBLESHOOTING (5 FULL METHODS)

### **Method #1: Registry Trick (EasySkeld Method)**
...
If modern OS versions hard-block the card at the kernel level. Older systems give the driver more control over the output.
...
5. **REBOOT REQUIRED.** This often removes patch-to-system conflicts.

---

## 📚 6. FACT SHEET: TECHNICAL INTEL
### **Full List of Mining GPUs (NVIDIA):**
* **P106-090:** Equivalent to **GTX 1050**.
* **P106-100:** Equivalent to **GTX 1060 6GB**.
* **P104-100:** Equivalent to **GTX 1070 8GB**. **(The best value)**.
* **P102-100:** Equivalent to **GTX 1080 Ti**. 
* **CMP 30HX - 90HX:** Turing/Ampere mining cards.

---

<a name="russian-version"></a>
# 🇷🇺 РУССКАЯ ИНСТРУКЦИЯ (RUSSIAN)
...
* [📦 ЭТАП 1: ПОДГОТОВКА](#3-этап-1-подготовка-software-pack)
* [🚀 ЭТАП 2: УСТАНОВКА](#4-этап-2-установка-пошагово)
* [🆘 ЧАСТЫЕ ПРОБЛЕМЫ (5 СПОСОБОВ)](#5-частые-проблемы-5-полных-способов-решения)
* [📚 СТРАНИЦА ФАКТОВ](#6-страница-фактов-технический-ликбез)
...
1. В BIOS найдите **DVMT Pre-Allocated** или **Internal Graphics Memory**.
2. Выдайте встройке **МАКСИМУМ памяти** (**Max** или **512MB/1024MB**).
3. Если система не грузится — чуть снизьте значение до стабильного предела.
...
5. **Важно:** **Не устанавливайте NVIDIA APP или GeForce Experience**, иначе патч может слететь!
...
Если современные ОС наглухо блокируют карту на уровне ядра. В старых системах драйвер имеет больше прав.

#### **Способ №4: Принудительное отключение Intel HD**
В Диспетчере устройств отключи **Intel HD Graphics**. Система потеряет аппаратное ускорение интерфейса, но будет вынуждена работать через P104-100.
